...
export default function EstablishmentsImportPage() {
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-6">
        <div className="flex items-center justify-between">
          ...
          <Link href="/admin/establishments" className="text-blue-600 hover:text-blue-800">
            ← Retour
          </Link>
        </div>
      </div>
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              ...
              <p className="mt-2 text-xs bg-yellow-100 p-2 rounded">
                💡 <strong>Test:</strong> Si vous voyez des caractères bizarres comme "P├⌐tionville" au lieu de "Pétionville",
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        ...
        <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
          ...
          <li>Remplissez votre fichier avec les données des établissements</li>
          ...
          <li>Le <code className="bg-blue-100 px-1 rounded">partnerId</code> est <strong>optionnel</strong> - laissez la colonne vide si l'établissement n'est pas lié à un partenaire</li>
      ...
      <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-yellow-800 space-y-1 list-disc list-inside">
          ...
          <li>Les établissements créés seront automatiquement actifs</li>
        </ul>
      </div>
    </div>
  );
